###########################################################################
## Makefile generated for component 'FanControl'. 
## 
## Makefile     : FanControl.mk
## Generated on : Wed Nov 12 21:38:44 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FanControl.exe
...
COMPILER_COMMAND_FILE     = FanControl_comp.rsp
CMD_FILE                  = FanControl.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FanControl.exe
...
DEFINES_STANDARD = -DMODEL=FanControl -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/FanControl_ert_rtw/FanControl.c

MAIN_SRC = $(START_DIR)/FanControl_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/FanControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FanControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FanControl_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FanControl_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/FanControl_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
FanControl.obj : $(START_DIR)/FanControl_ert_rtw/FanControl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/FanControl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
